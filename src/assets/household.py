...
class HouseHold(Consumer):
    ...
    def __init__(self, asset_id: int = None, num_residents: int = 1, name: str = "Household", personal_demand: float = 1.5):
        ...
        super().__init__(name = name, peak_power_demand=demand, consumption_profile=consumption_profile, asset_id=asset_id)
