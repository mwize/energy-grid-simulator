...
class ChargingStation(Consumer):
    ...
    def __init__(self, asset_id: int = None, priority: int = 0, name: str = "EV Cahrging Station", peak_power_demand: float = 3):
    ...
    def consume(self, current_hour) -> float:
        ...
        self.cars_charging = random.randint(0, 4)  # Randomly choose number of cars charging (0 to 4)
